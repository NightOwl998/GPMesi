...
<div class="container-fluid content-wrapper" id="content"> <!-- this is the Content Wrapper -->
    ...
    <div class="section article">
        <div class="heading">
            <p style="text-align: center;"><span style="color: #002e5b; font-size: 60px;"><strong><span style="font-family: 'Times New Roman',Times,serif;">Notifications<br></span></strong></span></p><br/>
        </div>
    </div>
<div class="section article">
...
while ($donnees = $req->fetch())
{
  ...
  ?>
  <div style="padding: 15px;text-align: center;height: 100px; border: 2px solid #ddd;
    border-radius: 5px;">
    <?php echo $donnees['Titre'];
         echo '<br>';
          echo $donnees['Notification'];
          ?>
  </div>
...
$req = $bdd->prepare('UPDATE notification SET Etat=1 WHERE Etat=0 AND IDcompte=:IDcompte ' );
$req->execute(array('IDcompte' => $_SESSION['compteID']));
$req->execute();
