...
<html>
<head>
<title> Consulter Les Fiche Descriptive</title>
	<meta charset="utf-8" />
...
<div class="title-wrapper">
	<div class="title-wrapper-inner">
	    ...
	    <div class="title ">
	        <a class="title  title-link" href="Responsable.html">
                GPMesi
            </a> 
	    </div>
	    <div class="subtitle">
        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse">
                <ul class="nav" id="topMenu" data-submenu="horizontal">
					<li class=" active ">
					<a href="Responsable.html">Responsable</a>
					</li>
...
<div class="container-fluid content-wrapper" id="content"> <!-- this is the Content Wrapper -->
    ...
    <div class="section article">
        <div class="heading">
            <p style="text-align: center;"><span style="color: #002e5b; font-size: 40px;"><strong><span style="font-family: 'Times New Roman',Times,serif;">Consulter les fiches descriptives </span></strong></span></p>
            <p> Recherche par mot clé/specialité</p>
        </div>
    </div>
   
	     <center>
<form      action="TraitementConsulterresp.php" method="post" >


<fieldset>
   <legend>   Le niveau  d'etude  </legend>
     <input type="checkbox" name="pfm" value="pfe" id = " pfe" checked = "checked" /> 
	 <label for="pfe" class="inline">pfe</label>
     <input type="checkbox" name="pfn"     value="master" id = "master"  checked="checked" /> 
	  <label for="master" class="inline">master</label>
</fieldset>
...
<fieldset>
 ...
 <p><input type="text" name="motcle"   placeholder=" ex:image,expert finding" /></p>
 </fieldset>
 
<fieldset>
 <label for="specialite"> </label>
<legend>  La Spécialité </legend> 
