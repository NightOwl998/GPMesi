...
<div style="padding : 1px 1px 1px 10px ;text-align: center;height: 190px; border: 2px solid #ddd;
    ...
    <label style="text-align: left;font-size: 20px"> <b style="color: #002e5b ;">Email:   </b> <?php echo'  ' .$_SESSION['Login']; ?> </label>
        ...
        <a href="newpassEmpFrom.php" style="text-align:  center;color: #002e5b ;font-size: 20px;text-decoration: none;"> Modifier Le Mot De Passe</a>
        <br>
     <a href ="deconnexionemp.php" style="text-align:  center;color: #002e5b ;font-size: 20px;text-decoration: none;"> Deconexion </a>
