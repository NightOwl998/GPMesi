...
<html>
<head>
	<title> Enseignants Retardataires </title>
	<meta charset="utf-8" />
...
<div class="container-fluid content-wrapper" id="content"> <!-- this is the Content Wrapper -->
    ...
    <div class="section article">
        <div class="heading">
            <p style="text-align: center;"><span style="color: #002e5b; font-size: 60px;"><strong><span style="font-family: 'Times New Roman',Times,serif;">Enseignants Retardataires</span></strong></span></p>
        </div>
    </div>
<div class="section article">
...
$i=0;
$req = $bdd->query('SELECT DISTINCT * FROM enseignant WHERE enseignantID NOT IN (SELECT enseignantID FROM fichevoeux);');
while($donnees = $req->fetch())
{
	$i++;
}
?>
<p color=black><strong> Nombre de retardataires : <?php echo $i ?></strong></p>

<div style="overflow-x:auto;">
	<table>
	<tr>
		<th style="border-bottom: 1px solid #ddd;padding: 15px;text-align: center;height: 30px;vertical-align: bottom;"> <strong> CompteID </strong></th>
		<th style="border-bottom: 1px solid #ddd;padding: 15px;text-align: center;height: 30px;vertical-align: bottom;"> <strong> Nom </strong></th>
		<th style="border-bottom: 1px solid #ddd;padding: 15px;text-align: center;height: 30px;vertical-align: bottom;"> <strong> Prénom </strong></th>
		<th style="border-bottom: 1px solid #ddd;padding: 15px;text-align: center;height: 30px;vertical-align: bottom;"><strong> Grade </strong></th>
		<th style="border-bottom: 1px solid #ddd;padding: 15px;text-align: center;height: 30px;vertical-align: bottom;"><strong> Email </strong></th>
	</tr>
<?php
...
while($donnees = $req->fetch())
{
	...
	<tr>
	<td style="border-bottom: 1px solid #ddd;padding: 15px;text-align: center;height: 30px;vertical-align: bottom;"><?php	echo $donnees['compteID'];?></td>
	<td style="border-bottom: 1px solid #ddd;padding: 15px;text-align: center;height: 30px;vertical-align: bottom;"><?php	echo $donnees['NomEnseignant'];?></td>
	<td style="border-bottom: 1px solid #ddd;padding: 15px;text-align: center;height: 30px;vertical-align: bottom;"><?php	echo $donnees['PrenomEnseignant'];?></td>
	<td style="border-bottom: 1px solid #ddd;padding: 15px;text-align: center;height: 30px;vertical-align: bottom;"><?php	echo $donnees['GradeEnseigant'];?></td>
	<td style="border-bottom: 1px solid #ddd;padding: 15px;text-align: center;height: 30px;vertical-align: bottom;"><?php	echo $donnees['EmailEnseignant'];?></td>
	</tr>
	<?php
}
