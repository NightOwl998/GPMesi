...
<div style="padding : 1px 1px 1px 10px ;text-align: center;height: 190px; border: 2px solid #ddd;
    ...
    <label style="text-align: left;font-size: 20px"> <b style="color: #002e5b ;">Email:   </b> <?php echo'  ' .$_SESSION['Login']; ?> </label>
        ...
        <a href="newpassResFrom.php" style="text-align:  center;color: #002e5b ;font-size: 20px;text-decoration: none;"> Modifier Le Mot De Passe</a>
        <br>
     <a href ="deconnexion.php" style="text-align:  center;color: #002e5b ;font-size: 20px;text-decoration: none;"> Deconexion </a>
        ...
        <h4>Responsable</h4>
               ...
               <div class="content" style="padding: 10px 10px 10px 25px; ">
                    ...
                    <ol style="list-style-image: url('152433314188167399.png');  ">
                      ...
                      <li><a  style="text-decoration: none" href="inscription_soutenance .php"><span>Une Soutenance</a></li>
                    </ol>
                    </li>
