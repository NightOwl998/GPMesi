...
$req->execute(array(
    ...
    <br>
    <?php	echo 'La Spécialité:'.$donnees1['SpecialitePFE'] ;?>
    <br>
    ...
    <?php echo "Pour visualiser la Fiche :<a href=".$chemin." target='_blank'> Cliquer ici  </a>";?>
             ...
             /* echo '<br />';
              ...
              echo '<br />';
              echo "Spécialité:".$donnees1['SpecialitePFE'];
              echo '<br />';
    ...
    <br>
    <?php	echo 'La Spécialité:'.$donnees2['SpecialiteMaster'] ;?>
    <br>
    ...
    <?php echo "Pour visualiser la Fiche :<a href=".$chemin." target='_blank'> Cliquer ici  </a>";?>
              ...
              echo '<br />';
              echo "Spécialité:".$donnees2['SpecialiteMaster'];
              echo '<br />';
              echo "<a href=".$chemin." target='_blank'> fichier  </a>";
              ?>
              </div>
