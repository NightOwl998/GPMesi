...
?>
						...
						<a href="fichiers_aide\help_responsable.php"><img style="width:30px;height:30px;-webkit-border-radius:15px;-moz-border-radius:15px;-o-border-radius:15px;border-radius:15px;" src="help1.png"></a>
...
<div class="container-fluid content-wrapper" id="content"> <!-- this is the Content Wrapper -->
    ...
    <div class="section article">
        <div class="heading">
            <p style="text-align: center;"><span style="color: #002e5b; font-size: 60px;"><strong><span style="font-family: 'Times New Roman',Times,serif;">Responsable de Service de Stage<br><br><br></span></strong></span></p><br/>
        </div>
    </div>
<div class="section article">
...
<div class="img-simple span12 ">
			<div class="image" left=50px >
	
				<a data-ss="imagemodal" data-href="image_fond.jpg" ><img src="image_fond.jpg"></a>
			</div>
		</div>
